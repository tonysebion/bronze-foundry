"""Infrastructure-level helpers for extractor registration and construction."""
...
from .base import BaseExtractor, EXTRACTOR_REGISTRY, get_extractor_class

_loaded = False


def _load_extractors() -> None:
    extractors_pkg = importlib.import_module("core.domain.adapters.extractors")

...
- Bronze hybrid samples (full reference plus 14 days of CDC or incremental deltas) now appear under `docs/examples/data/bronze_samples/hybrid_cdc/...` and `.../hybrid_incremental/...`; rerun `python scripts/generate_sample_data.py` to refresh them.

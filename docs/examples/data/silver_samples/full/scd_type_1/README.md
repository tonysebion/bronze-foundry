# Full silver samples (scd type 1)

This folder contains silver artifacts produced from the Bronze `full` samples using the `scd_type_1` Silver model.

- **Source Bronze pattern**: `full`
- **Silver model**: `scd_type_1`
